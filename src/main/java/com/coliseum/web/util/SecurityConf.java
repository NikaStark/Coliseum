...
public enum SecurityConf {
    ...
    ERROR_PAGE_ACCESS(Command.ERROR_PAGE_CMD, new Role[]{Role.GUEST, Role.CLIENT, Role.MANAGER, Role.ADMIN}),
    ...
    ADD_TO_BASKET_ACCESS(Command.ADD_TO_BASKET_CMD, new Role[]{Role.GUEST, Role.CLIENT}),
    REMOVE_FROM_BASKET_ACCESS(Command.REMOVE_FROM_BASKET_CMD, new Role[]{Role.CLIENT}),
    BUY_BASKET_ACCESS(Command.BUY_BASKET_CMD, new Role[]{Role.CLIENT});
